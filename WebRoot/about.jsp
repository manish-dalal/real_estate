            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="at-inner-title-box">
                        <h2>About</h2>
                        <p><a href="home.jsp">Home</a> <i class="fa fa-angle-double-right" aria-hidden="true"></i> <a href="#">About</a>
                        </p>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="at-sec-title at-sec-title-left">
                        ...
                        <p>Some of the future changes and advancement that can be brought to this website are as follow:</p>
                    </div>
                </div>
            </div>
            <div class="row">
