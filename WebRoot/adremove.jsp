            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="at-inner-title-box">
                        ...
                        <p><a href="adminHomePage.jsp">Home</a> <i class="fa fa-angle-double-right" aria-hidden="true"></i> <a href="#">Remove Building</a>
                        </p>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <form class="input-group" action="remove" method="get">
                        <div class="form-group">
                            <input style="color: white;" class="form-control" name="pid" id="pid" placeholder="ENTER PROPERTY ID  ">
                        </div>
